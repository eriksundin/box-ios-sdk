//
//  BoxFolderModel+SaveableSelectedFolder.h
//  BoxPopup
//
...
/*
 * BoxFolderModel+SaveableSelectedFolder adds some basic save and retrieval functionality to BoxFolderModel that is specific to the BoxPopup.
...
@interface BoxFolderModel (SaveableFolder) 
