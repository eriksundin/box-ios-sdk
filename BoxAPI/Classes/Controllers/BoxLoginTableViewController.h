...
@interface BoxLoginTableViewController : UITableViewController <BoxFolderRetrievalCallback, BoxActionChooserDelegate, UIAlertViewDelegate>{
	...
	IBOutlet UITextView		 * _additionalInfoView;
...
@property (assign) BoxActionType actionType;
