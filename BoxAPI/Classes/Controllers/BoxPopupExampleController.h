...
@protocol BoxPopupExampleControllerDelegate <NSObject>
...
@interface BoxPopupExampleController : UIViewController <BoxPopupDelegate> {
	...
	id<BoxPopupExampleControllerDelegate> _delegate;
}

@property (assign) id<BoxPopupExampleControllerDelegate> delegate;
