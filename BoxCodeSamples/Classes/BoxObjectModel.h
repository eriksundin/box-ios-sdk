 ...
 */
@interface BoxObjectModel : NSObject {
...
// objectId is the identifier that uniquely identifies a given file or folder on box. It is used as a parameter when you want to make changes to a file,
// downlaod or share a file.
